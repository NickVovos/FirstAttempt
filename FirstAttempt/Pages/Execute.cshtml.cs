        ...
        public void OnGet(int? recipeId, int? step)
        {
            ...
            AvailableRecipes = new List<Recipe>
            {
                ...
                new Recipe
                {
                    ...
                    Ingredients = new List<Ingredient>
                    {
                        new() { Id = 1, Name = "Pizza Dough", Quantity = "1 base" },
                        new() { Id = 2, Name = "Tomato Sauce", Quantity = "200ml" },
                        new() { Id = 3, Name = "Mozzarella Cheese", Quantity = "200g" },
                        new() { Id = 4, Name = "Fresh Basil", Quantity = "a handful" },
                    },
                    Steps = new List<Step>
                    {
